      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end" className="w-80">
          ...
          <div className="space-y-2 p-2">
            <div className="p-2 hover:bg-muted rounded-sm">
              <p className="text-sm font-medium">New issue assigned</p>
              <p className="text-xs text-muted-foreground">Issue #123 has been assigned to you</p>
            </div>
            <div className="p-2 hover:bg-muted rounded-sm">
              <p className="text-sm font-medium">Comment added</p>
              <p className="text-xs text-muted-foreground">Sarah commented on issue #456</p>
            </div>
          </div>
        </DropdownMenuContent>
      </DropdownMenu>
